...
" -w scene-2.wavespeak "dark matter(s) odessey
...
" -w scene0.wavespeak "chapter  1: the awakening
...
" -w scene1.wavespeak "chapter  2: engine room
...
" -w scene2.wavespeak "chapter  3: night train
...
" -w scene3.wavespeak "chapter  4: harmony swarm
...
" -w scene4.wavespeak "chapter  5: pentatiano
...
" -w scene5.wavespeak "chapter  6: cheater chord inversion
...
" -w scene6.wavespeak "chapter  7: de4d mouse
...
" -w scene7.wavespeak "chapter  8: bug is raising
